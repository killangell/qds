...
class Ui_obj_sw_doc(object):
    ...
    def retranslateUi(self, obj_sw_doc):
        ...
        self.txt_func_doc.setPlainText("软件原理：在当前周期下，参考EMA快慢线，以最近的一次完整周期EMA值为依据，EMA快线大于EMA慢线，多头趋势只做多，EMA快线小于EMA慢线，空头趋势只作空。"
                                       "趋势（金叉死叉）变化时，立即平仓所有持仓和挂单，重新按新趋势的点位重新挂单。一次交易开始之后，未止盈或者趋势变化之前，不再进行新的挂单操作。"
